R"=====(448-0.324,0.548-0.949,0.225-1.396
...
const githubLink = `<a class="icon-link" href="https://github.com/JPHutchins" target="_blank" rel="noreferrer">${githubIcon}</a>`</script>)====="