...
const aboutContent = () => {
    ...
    aboutContent.setAttribute("id", "help-container")
    aboutContent.innerHTML = `
        ...
        <h2>technologies</h2>
            ...
            is written in C style C++.  library_explorer is written in plain
        ...
        <h2>contribute</h2>
            <p>
            This project has some important future goals.
            </p>
            
            <li>Complete Mac OS and Linux binaries.</li>
            <li>Update library_explorer to respect media-types other than audio.</li>
            <li>Allow library_finder to take multiple root path arguments and display multiple results in library_explorer.</li>
            <li>Test and consider varying the search algorithm.</li>
            <li>Implement media preview in library_explorer.</li>
            <hr>
        </div>
        `
    return aboutContent;
...
const footerContent = () => {
    ...
    footerContent.innerHTML = `
        Copyright(C) 2020 J.P. Hutchins.  GNU General Public License.
        <br>
